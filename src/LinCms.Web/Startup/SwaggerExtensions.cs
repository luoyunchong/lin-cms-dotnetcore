...
public static class SwaggerExtensions
{
    ...
    public static IServiceCollection AddSwaggerGen(this IServiceCollection services)
    {
        ...
        //Swagger重写PascalCase，改成SnakeCase模式..ApiDescriptionProvider
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            try
            {
                ...
                //实体层的xml文件名
                string xmlEntityPath = Path.Combine(AppContext.BaseDirectory, $"{typeof(ApplicationService).Assembly.GetName().Name}.xml");
