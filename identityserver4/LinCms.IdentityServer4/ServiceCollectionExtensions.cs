...
namespace LinCms.IdentityServer4
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            var c = services.BuildServiceProvider().GetRequiredService<IConfiguration>();
            ...
            services
                ...
                .AddAuditRepostiory(typeof(long))
        ...
        public static IServiceCollection AddServices(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new OpenApiInfo()
                {
                    ...
                    {
                        Name = ApiName, Email = "luoyunchong@foxmail.com",
                    ...
                    License = new OpenApiLicense
                    {
                        Name = ApiName + " 官方文档",
                        Url = new Uri(
                            "https://luoyunchong.github.io/igeekfan-docs/dotnetcore/lin-cms/dotnetcore-start.html")
                    }
                });
            ...
            services.AddControllersWithViews(options => { options.Filters.Add<LinCmsExceptionFilter>(); })
